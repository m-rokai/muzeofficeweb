...
export const cityServiceData: Record<string, CityServiceData> = {
  ...
  "las-vegas-virtual-office": {
    ...
    heroSubtitle:
      "A real business address on Bermuda Rd — not a PO Box. Use it for your LLC, Google Business Profile, contracts, and mail. Meeting rooms included.",
    metaTitle: "Virtual Office Las Vegas | From $39/mo",
    metaDescription:
      "Get a professional Las Vegas business address with mail handling, LLC registration, and meeting room access. Mail Holding plans start at $39/mo. Month-to-month. No lease required.",
    heroImage: "/images/hero/virtual-office.jpg",
    useCases: [
      "Remote workers who need a professional address",
      "LLC and business registration in Nevada",
      "Out-of-state businesses establishing a Las Vegas presence",
      "Freelancers and consultants who meet clients occasionally",
    ...
    longFormBody: {
      bestFor: [
        ...
        },
        {
          ...
          scenario:
            "You work from home most days, but once or twice a month a client flies into Las Vegas or asks for an in-person meeting, and you need a professional conference room — not a Starbucks on Paradise Rd.",
          fit: [
  ...
  "houston-virtual-office": {
    ...
    heroSubtitle:
      "A professional Houston business address near the Galleria. Use it for your LLC, Google Business Profile, contracts, and mail. Meeting rooms included.",
    metaTitle: "Virtual Office Houston | Coming Soon",
    metaDescription:
      "Get a professional Houston business address near the Galleria with mail handling, LLC registration, and meeting room access. Coming soon to Muze Office Houston.",
    heroImage: "/images/hero/virtual-office.jpg",
    useCases: [
      "Remote workers who need a Houston business address",
      "LLC and business registration in Texas",
      "Out-of-state businesses expanding to Houston",
      "Freelancers and consultants in the Galleria area",
      "E-commerce businesses that need a real street address",
      "Medical professionals near the Texas Medical Center",
    ],
    locationCallout:
      "Near Houston's Galleria / Uptown district, accessible from I-610 West Loop. Close to Post Oak Blvd and the Texas Medical Center.",
  },
  ...
  "houston-coworking": {
    ...
    heroSubtitle:
      "Flexible shared workspace in Houston's Uptown district. Fast WiFi, coffee, parking, and meeting rooms included. Day passes and monthly memberships available.",
    metaTitle: "Coworking Space Houston | Coming Soon",
    metaDescription:
      "Houston coworking near the Galleria with day passes and monthly memberships. Free parking, fast WiFi, coffee, meeting rooms. Coming soon to Muze Office Houston.",
    heroImage: "/images/hero/coworking-space.jpg",
    useCases: [
      "Remote workers in the Galleria and Uptown area",
      "Freelancers looking for a productive workspace",
      "Traveling professionals visiting Houston",
      "Small teams who want flexible space without a lease",
      "Startup founders building their Houston presence",
      "Sales reps between client meetings",
    ],
    locationCallout:
      "Located near the Galleria / Uptown district, off I-610 West Loop. Easy access to Post Oak Blvd and surrounding business districts.",
  },
  ...
  "houston-private-office": {
    ...
    heroSubtitle:
      "Furnished private offices in Houston's Uptown district. Month-to-month terms, all utilities included. WiFi, conference rooms, and parking included.",
    metaTitle: "Private Office Houston | Coming Soon",
    metaDescription:
      "Furnished private offices in Houston near the Galleria. Month-to-month leases with WiFi, utilities, meeting rooms, and parking included. Coming soon.",
    heroImage: "/images/hero/private-office.jpg",
    useCases: [
      "Growing startups that need their own space in Houston",
      "Law firms and CPAs near the Galleria",
      "Teams of 1-10 who want a lockable, private office",
      "Companies seeking flexible terms in Uptown Houston",
      "Medical and health-tech professionals",
      "Businesses that need a professional Galleria address",
    ],
    locationCallout:
      "Near the Galleria / Uptown district, accessible from I-610 West Loop. Close to Post Oak Blvd and surrounding business hubs.",
  },
  ...
  "houston-meeting-rooms": {
    ...
    heroSubtitle:
      "Professional meeting spaces near the Galleria available by the hour. AV equipment, video conferencing, and parking included.",
    metaTitle: "Meeting Rooms Houston | Coming Soon",
    metaDescription:
      "Book professional meeting rooms in Houston near the Galleria. AV equipment, video conferencing, parking included. Coming soon to Muze Office Houston.",
    heroImage: "/images/hero/meeting-room.jpg",
    useCases: [
      "Client presentations and sales pitches",
      "Video conferencing and remote team calls",
      "Legal depositions and mediations",
      "Team workshops and strategy sessions",
      "Board meetings and investor presentations",
      "Job interviews and onboarding sessions",
    ],
    locationCallout:
      "Near the Galleria / Uptown district with easy access from I-610 West Loop. Parking available for all attendees.",
  },
  ...
  "houston-event-space": {
    ...
    heroSubtitle:
      "Host corporate events, workshops, and private gatherings in Houston's Uptown district. Full AV, flexible layouts, and catering available.",
    metaTitle: "Event Space Houston | Coming Soon",
    metaDescription:
      "Rent event space in Houston near the Galleria. Full AV, flexible layouts, catering available. Corporate events, workshops, and private gatherings. Coming soon.",
    heroImage: "/images/hero/event-space.jpg",
    useCases: [
      "Corporate workshops and training sessions",
      "Houston networking events and mixers",
      "Product launches and company demos",
      "Private parties and team celebrations",
      "Industry seminars and panel discussions",
      "Company retreats and team offsites",
    ],
    locationCallout:
      "Near the Galleria / Uptown district, off I-610 West Loop. Easy access for guests across Houston. Parking available on-site.",
  },
  ...
  "houston-galleria-coworking": {
    ...
    heroSubtitle:
      "Modern flexible workspace steps from Post Oak Blvd and the Houston Galleria. Day passes and monthly memberships in Houston's premier business district.",
    metaTitle: "Galleria Coworking Houston | Coming Soon",
    metaDescription:
      "Coworking near the Houston Galleria in Uptown. Day passes, hot desks, and dedicated desks. Fast WiFi, free parking, meeting rooms. Coming soon to Muze Office.",
    heroImage: "/images/hero/coworking-space.jpg",
    useCases: [
      ...
      "Remote workers looking for a premium work environment",
      "Sales teams that need a Houston base of operations",
    ],
    locationCallout:
      "Steps from the Houston Galleria and Post Oak Blvd, off I-610 West Loop. Houston's premier business and shopping district.",
  },
  ...
  "houston-medical-center-coworking": {
    ...
    heroSubtitle:
      "Flexible workspace for medical professionals, health-tech startups, and researchers near the Texas Medical Center. HIPAA-aware private offices available.",
    metaTitle: "Medical Center Coworking Houston | Soon",
    metaDescription:
      "Coworking near the Texas Medical Center in Houston. For medical professionals, health-tech startups, and researchers. HIPAA-aware offices available. Coming soon.",
    heroImage: "/images/hero/coworking-space.jpg",
    useCases: [
      "Medical professionals who need flexible office space",
      "Health-tech startups near the Texas Medical Center",
      "Researchers and academics who need a quiet workspace",
      "Pharmaceutical reps visiting the Medical Center",
      "Telehealth providers who need HIPAA-aware space",
      "Healthcare consultants between hospital meetings",
    ],
    locationCallout:
      "Close to the Texas Medical Center, accessible from I-610 West Loop. Approximately 15 minutes from the Galleria / Uptown area.",
  },
};
