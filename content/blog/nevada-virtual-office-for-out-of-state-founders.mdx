...
- **USPS Form 1583, handled remotely.** Federal rules require a notarized PS Form 1583 (the current April 2023 revision, available from [USPS](https://about.usps.com/forms/ps1583.pdf)) before any commercial mail agency can accept your mail. The good news for remote owners: you can complete it with a remote online notary by webcam, often for around $25 — no flight to Vegas required.
...
2. Lock in a real commercial address with [a Las Vegas virtual office](/las-vegas-virtual-office) and complete Form 1583 with a remote notary.
